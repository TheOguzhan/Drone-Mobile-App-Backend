...
func IsUserConfirmed(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldIsUserConfirmed, v))
}
...
func IsUserConfirmedEQ(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldIsUserConfirmed, v))
}

// IsUserConfirmedNEQ applies the NEQ predicate on the "is_user_confirmed" field.
func IsUserConfirmedNEQ(v bool) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldIsUserConfirmed, v))
}
...
// AuthTokensIsNil applies the IsNil predicate on the "auth_tokens" field.
func AuthTokensIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldAuthTokens))
}
