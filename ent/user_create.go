...
func (uc *UserCreate) SetIsUserConfirmed(b bool) *UserCreate {
...
func (uc *UserCreate) SetNillableIsUserConfirmed(b *bool) *UserCreate {
	if b != nil {
...
func (uc *UserCreate) SetAuthTokens(s []string) *UserCreate {
	uc.mutation.SetAuthTokens(s)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.IsUserConfirmed(); !ok {
		return &ValidationError{Name: "is_user_confirmed", err: errors.New(`ent: missing required field "User.is_user_confirmed"`)}
	}
